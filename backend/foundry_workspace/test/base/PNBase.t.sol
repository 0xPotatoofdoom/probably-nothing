...
abstract contract PNBase is BaseTest {
    ...
    function setUp() public virtual {
        ...
        // detected constructor signature. For standard hooks: abi.encode(poolManager).
        // For hooks with an owner param: abi.encode(poolManager, address(this)).
        bytes memory ctorArgs = HookConfig.ctorArgs(address(poolManager));
